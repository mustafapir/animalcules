...
observeEvent("", {
  print(runid())
  if (runid() != ""){
    count_table <- read.table(paste0(script_path(), runid(), "/animalcules_out/animalcules_out/", "reads.txt"),
                              header = TRUE,
                              row.names = 1,
    ...
    tax_table <- read.table(paste0(script_path(), runid(), "/animalcules_out/animalcules_out/", "taxonomy.txt"),
                            header = TRUE,
                            sep = "\t",
                            row.names= 1,
                            stringsAsFactors=FALSE,
    ...
    metadata_table <- read.table(paste0(script_path(), runid(), "/animalcules_out/animalcules_out/", "metadata.txt"),
                                 header = TRUE,
                                 sep = "\t",
                                 row.names=1,
                                 stringsAsFactors=FALSE,
